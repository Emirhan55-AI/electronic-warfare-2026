...
def build_fixtures() -> tuple[P0Fixture, ...]:
    ...
    weak = 0.0006 * np.exp(2j * np.pi * 20_000.0 * time) + 0.008 * (
    ...
    fixtures = (
        ...
        P0Fixture("wideband-noise-like", wide, (wide_truth_centroid,), 20_250.0, "Belirsiz", "known_region"),
        P0Fixture("two-adjacent-signals", adjacent, (center - 30_000.0, center - 24_000.0), 750.0, None),
        P0Fixture("weak-near-threshold", weak, (center + 20_000.0,), None, None),
    )
