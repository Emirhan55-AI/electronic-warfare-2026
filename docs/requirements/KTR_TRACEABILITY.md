...
| KTR-6 | 6 Simülasyon ve Test | Modelleri ve donanım uygulamasını doğrulama | Deterministik veri, referans model, RTL testleri ve aşamalı donanım kanıtları | PHASE-00 ve devamı | Otomatik testler, karşılaştırmalı sonuçlar ve faz kanıtları | Planlandı |
