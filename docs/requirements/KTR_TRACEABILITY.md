...
| KTR-6 | 6 Simülasyon ve Test | Modelleri ve donanım uygulamasını doğrulama | Deterministik veri, floating-point spektrum/tespit modelleri, seri hâle getirilebilir doğrulanmış profil ve aşamalı yazılım/RTL/donanım kanıtları | PHASE-00 ve devamı | Golden ölçümler, eşlenik Monte Carlo, UI render/performance testleri, sonraki karşılaştırmalı RTL ve donanım sonuçları | Kısmi — PHASE-03 yazılım kanıtı |
