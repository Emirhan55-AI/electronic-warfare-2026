...
| PHASE-04 | Parametre çıkarımı | Tespit adaylarının merkez frekansı, bant genişliği ve güç ölçümleri tanımlı kabul toleranslarında referans sonuçlarla eşleşir; gerçek bloklar oluştukça Akış Tasarımı editörü geliştirilir. |
| PHASE-05 | Sinyal izleme ve analog dinleme | İzinli kayıtlı analog sinyaller izlenir ve seçilen demodülasyon zinciri tekrarlanabilir testlerde doğrulanır; ilgili bloklar Akış Tasarımı alanına eklenir. |
| PHASE-06 | FPGA RTL DSP zinciri | PC, ZedBoard PS ve PL yürütme hedefleri tanımlanır; her PL bloğunun sabit nokta, gecikme, kaynak ve RTL sonucu referans modelle eşleştirilir. Görsel profilin otomatik HDL ürettiği iddia edilmez. |
