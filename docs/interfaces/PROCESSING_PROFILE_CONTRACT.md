...
PHASE-05 analog dinleme tam bir parametre veya modülasyon profili değildir. Byte-sabit PHASE-03 `regional` olayından sonra operatörün açık AM/NFM seçimi, merkez ofseti ve kanal genişliğiyle bounded monitoring görevi kurulur. PHASE-04/E1 bağı aranmaz ve otomatik sınıflandırma yapılmaz. Kaynak/pipeline/yapılandırma/event nesli değişince görev ve ses silinir; stale sonuç uygulanmaz. Gerçek HackRF dinleme bu kayıtlı-veri sözleşmesiyle doğrulanmış sayılmaz.
